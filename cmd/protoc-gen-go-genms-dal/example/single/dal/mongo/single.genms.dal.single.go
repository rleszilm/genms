...
func (x *SingleCollection) Filter(context.Context, *dal.SingleFieldValues) ([]*single.Single, error) {
	return nil, nil
}

// Insert implements SingleCollectionWriter
func (x *SingleCollection) Insert(context.Context, *single.Single) (*single.Single, error) {
	return nil, nil
}

// Upsert implements SingleCollectionWriter
func (x *SingleCollection) Upsert(context.Context, *single.Single) (*single.Single, error) {
	return nil, nil
}

// Update implements SingleCollectionWriter
func (x *SingleCollection) Update(context.Context, *single.Single, *dal.SingleFieldValues) (*single.Single, error) {
	return nil, nil
}
...
func (x *SingleCollection) MultipleParam(ctx context.Context, scalar_int32 int32, scalar_int64 int64, scalar_float32 float32) ([]*single.Single, error) {
	filter := bson.M{
		"scalar_int32": scalar_int32, "scalar_int64": scalar_int64, "scalar_float32": scalar_float32,
	}
...
func (x *SingleCollection) WithRest(ctx context.Context, scalar_int32 int32, scalar_int64 int64, scalar_float32 float32, scalar_float64 float64) ([]*single.Single, error) {
	filter := bson.M{
		"scalar_int32": scalar_int32, "scalar_int64": scalar_int64, "scalar_float32": scalar_float32, "scalar_float64": scalar_float64,
	}
