...
type SingleFieldValues struct {
	...
	BsonBytesOid       *[]byte
	ScalarInt32Opt     *int32
	ScalarInt64Opt     *int64
	ScalarFloat32Opt   *float32
	ScalarFloat64Opt   *float64
	ScalarStringOpt    *string
	ScalarBytesOpt     []byte
	ScalarBoolOpt      *bool
	ScalarEnumOpt      *single.Single_Enum
	ObjMessageOpt      *single.Single_Message
	RenamedOpt         *string
	IgnoredPostgresOpt *string
	RenamedPostgresOpt *string
	IgnoredRestOpt     *string
	RenamedRestOpt     *string
	IgnoredMongoOpt    *string
	RenamedMongoOpt    *string
	BsonStringOidOpt   *string
	BsonBytesOidOpt    []byte
}
