...
func (x *SingleCollection) Filter(ctx context.Context, fvs *dal.SingleFieldValues) ([]*single.Single, error) {
	query := "SELECT scalar_int32, scalar_int64, scalar_float32, scalar_float64, scalar_string, scalar_bytes, scalar_bool, many_scalar_bool, scalar_enum, obj_message, many_obj_message, ignored, aliased, ignored_postgres, aliased_postgres, ignored_rest, renamed_rest, ignored_mongo, renamed_mongo, bson_string_oid, bson_bytes_oid FROM " + x.config.TableName
...
func NewSingleCollection(instance string, db sql.DB, queries SingleQueryTemplateProvider, config *SingleConfig) (*SingleCollection, error) {
	...
	queryReplacements := map[string]string{
		...
		"fields":      "scalar_int32, scalar_int64, scalar_float32, scalar_float64, scalar_string, scalar_bytes, scalar_bool, many_scalar_bool, scalar_enum, obj_message, many_obj_message, ignored, aliased, ignored_postgres, aliased_postgres, ignored_rest, renamed_rest, ignored_mongo, renamed_mongo, bson_string_oid, bson_bytes_oid",
		"writeFields": ":scalar_int32, :scalar_int64, :scalar_float32, :scalar_float64, :scalar_string, :scalar_bytes, :scalar_bool, :many_scalar_bool, :scalar_enum, :obj_message, :many_obj_message, :ignored, :aliased, :ignored_postgres, :aliased_postgres, :ignored_rest, :renamed_rest, :ignored_mongo, :renamed_mongo, :bson_string_oid, :bson_bytes_oid",
	}
