...
func (fake *FakeUserCollection) Dependencies() service.Services {
...
func (fake *FakeUserCollection) DependenciesCallCount() int {
	fake.dependenciesMutex.RLock()
	defer fake.dependenciesMutex.RUnlock()
	return len(fake.dependenciesArgsForCall)
}

func (fake *FakeUserCollection) DependenciesCalls(stub func() service.Services) {
	fake.dependenciesMutex.Lock()
	defer fake.dependenciesMutex.Unlock()
	fake.DependenciesStub = stub
}

func (fake *FakeUserCollection) DependenciesReturns(result1 service.Services) {
	fake.dependenciesMutex.Lock()
	defer fake.dependenciesMutex.Unlock()
...
func (fake *FakeUserCollection) DependenciesReturnsOnCall(i int, result1 service.Services) {
	fake.dependenciesMutex.Lock()
	defer fake.dependenciesMutex.Unlock()
	fake.DependenciesStub = nil
...
func (fake *FakeUserCollection) Filter(arg1 context.Context, arg2 *dal_users.UserFields) ([]*users.User, error) {
...
func (fake *FakeUserCollection) FilterCalls(stub func(context.Context, *dal_users.UserFields) ([]*users.User, error)) {
	fake.filterMutex.Lock()
	defer fake.filterMutex.Unlock()
	fake.FilterStub = stub
}

func (fake *FakeUserCollection) FilterArgsForCall(i int) (context.Context, *dal_users.UserFields) {
	fake.filterMutex.RLock()
	defer fake.filterMutex.RUnlock()
