...
func (fake *FakeUserCollectionReader) All(arg1 context.Context) ([]*usersa.User, error) {
	fake.allMutex.Lock()
...
func (fake *FakeUserCollectionReader) AllCalls(stub func(context.Context) ([]*usersa.User, error)) {
	fake.allMutex.Lock()
...
func (fake *FakeUserCollectionReader) AllReturns(result1 []*usersa.User, result2 error) {
	fake.allMutex.Lock()
	defer fake.allMutex.Unlock()
	fake.AllStub = nil
...
func (fake *FakeUserCollectionReader) AllReturnsOnCall(i int, result1 []*usersa.User, result2 error) {
	fake.allMutex.Lock()
	defer fake.allMutex.Unlock()
	fake.AllStub = nil
...
func (fake *FakeUserCollectionReader) ById(arg1 context.Context, arg2 int64) ([]*usersa.User, error) {
	fake.byIdMutex.Lock()
...
func (fake *FakeUserCollectionReader) ByIdCalls(stub func(context.Context, int64) ([]*usersa.User, error)) {
	fake.byIdMutex.Lock()
...
func (fake *FakeUserCollectionReader) ByIdReturns(result1 []*usersa.User, result2 error) {
	fake.byIdMutex.Lock()
	defer fake.byIdMutex.Unlock()
	fake.ByIdStub = nil
...
func (fake *FakeUserCollectionReader) ByIdReturnsOnCall(i int, result1 []*usersa.User, result2 error) {
	fake.byIdMutex.Lock()
	defer fake.byIdMutex.Unlock()
	fake.ByIdStub = nil
...
func (fake *FakeUserCollectionReader) ByKind(arg1 context.Context, arg2 usersa.User_Kind) ([]*usersa.User, error) {
...
func (fake *FakeUserCollectionReader) ByKindCalls(stub func(context.Context, usersa.User_Kind) ([]*usersa.User, error)) {
	fake.byKindMutex.Lock()
	defer fake.byKindMutex.Unlock()
	fake.ByKindStub = stub
}

func (fake *FakeUserCollectionReader) ByKindArgsForCall(i int) (context.Context, usersa.User_Kind) {
	fake.byKindMutex.RLock()
	defer fake.byKindMutex.RUnlock()
...
func (fake *FakeUserCollectionReader) ByKindReturns(result1 []*usersa.User, result2 error) {
	fake.byKindMutex.Lock()
	defer fake.byKindMutex.Unlock()
	fake.ByKindStub = nil
...
func (fake *FakeUserCollectionReader) ByKindReturnsOnCall(i int, result1 []*usersa.User, result2 error) {
	fake.byKindMutex.Lock()
	defer fake.byKindMutex.Unlock()
	fake.ByKindStub = nil
...
func (fake *FakeUserCollectionReader) ByNameAndDivision(arg1 context.Context, arg2 string, arg3 string) ([]*usersa.User, error) {
...
func (fake *FakeUserCollectionReader) ByNameAndDivisionCalls(stub func(context.Context, string, string) ([]*usersa.User, error)) {
	fake.byNameAndDivisionMutex.Lock()
...
func (fake *FakeUserCollectionReader) ByNameAndDivisionReturns(result1 []*usersa.User, result2 error) {
	fake.byNameAndDivisionMutex.Lock()
	defer fake.byNameAndDivisionMutex.Unlock()
...
func (fake *FakeUserCollectionReader) ByNameAndDivisionReturnsOnCall(i int, result1 []*usersa.User, result2 error) {
	fake.byNameAndDivisionMutex.Lock()
	defer fake.byNameAndDivisionMutex.Unlock()
	fake.ByNameAndDivisionStub = nil
...
func (fake *FakeUserCollectionReader) ByPhone(arg1 context.Context, arg2 *types.Phone) ([]*usersa.User, error) {
...
func (fake *FakeUserCollectionReader) ByPhoneCalls(stub func(context.Context, *types.Phone) ([]*usersa.User, error)) {
	fake.byPhoneMutex.Lock()
...
func (fake *FakeUserCollectionReader) ByPhoneReturns(result1 []*usersa.User, result2 error) {
	fake.byPhoneMutex.Lock()
	defer fake.byPhoneMutex.Unlock()
...
func (fake *FakeUserCollectionReader) ByPhoneReturnsOnCall(i int, result1 []*usersa.User, result2 error) {
	fake.byPhoneMutex.Lock()
	defer fake.byPhoneMutex.Unlock()
	fake.ByPhoneStub = nil
...
func (fake *FakeUserCollectionReader) Filter(arg1 context.Context, arg2 *users.UserFilter) ([]*usersa.User, error) {
...
func (fake *FakeUserCollectionReader) FilterCalls(stub func(context.Context, *users.UserFilter) ([]*usersa.User, error)) {
	fake.filterMutex.Lock()
	defer fake.filterMutex.Unlock()
	fake.FilterStub = stub
}

func (fake *FakeUserCollectionReader) FilterArgsForCall(i int) (context.Context, *users.UserFilter) {
	fake.filterMutex.RLock()
	defer fake.filterMutex.RUnlock()
...
func (fake *FakeUserCollectionReader) FilterReturns(result1 []*usersa.User, result2 error) {
	fake.filterMutex.Lock()
	defer fake.filterMutex.Unlock()
	fake.FilterStub = nil
...
func (fake *FakeUserCollectionReader) FilterReturnsOnCall(i int, result1 []*usersa.User, result2 error) {
	fake.filterMutex.Lock()
	defer fake.filterMutex.Unlock()
	fake.FilterStub = nil
...
func (fake *FakeUserCollectionReader) InterfaceStubOnly(arg1 context.Context) ([]*usersa.User, error) {
...
func (fake *FakeUserCollectionReader) InterfaceStubOnlyCalls(stub func(context.Context) ([]*usersa.User, error)) {
	fake.interfaceStubOnlyMutex.Lock()
...
func (fake *FakeUserCollectionReader) InterfaceStubOnlyReturns(result1 []*usersa.User, result2 error) {
	fake.interfaceStubOnlyMutex.Lock()
	defer fake.interfaceStubOnlyMutex.Unlock()
...
func (fake *FakeUserCollectionReader) InterfaceStubOnlyReturnsOnCall(i int, result1 []*usersa.User, result2 error) {
	fake.interfaceStubOnlyMutex.Lock()
	defer fake.interfaceStubOnlyMutex.Unlock()
	fake.InterfaceStubOnlyStub = nil
...
func (fake *FakeUserCollectionReader) ProviderStubOnly(arg1 context.Context) ([]*usersa.User, error) {
...
func (fake *FakeUserCollectionReader) ProviderStubOnlyCalls(stub func(context.Context) ([]*usersa.User, error)) {
	fake.providerStubOnlyMutex.Lock()
...
func (fake *FakeUserCollectionReader) ProviderStubOnlyReturns(result1 []*usersa.User, result2 error) {
	fake.providerStubOnlyMutex.Lock()
	defer fake.providerStubOnlyMutex.Unlock()
...
func (fake *FakeUserCollectionReader) ProviderStubOnlyReturnsOnCall(i int, result1 []*usersa.User, result2 error) {
	fake.providerStubOnlyMutex.Lock()
	defer fake.providerStubOnlyMutex.Unlock()
	fake.ProviderStubOnlyStub = nil
...
var _ users.UserCollectionReader = new(FakeUserCollectionReader)
