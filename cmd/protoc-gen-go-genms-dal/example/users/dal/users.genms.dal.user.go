...
type UserCollectionWriter interface {
	...
	Update(context.Context, *users.User, *UserOptions) (*users.User, error)
}
...
type UserCollectionReader interface {
	...
	Filter(context.Context, *UserOptions) ([]*users.User, error)
...
// UserOptions is an autogenerated struct that can be used in the generic queries against UserCollection.
...
func (x *UnimplementedUserCollection) Update(_ context.Context, _ *users.User, _ *UserOptions) (*users.User, error) {
	return nil, ErrUserCollectionMethodImpl
}

// Filter implements UserCollection.Filter
func (x *UnimplementedUserCollection) Filter(_ context.Context, _ *UserOptions) ([]*users.User, error) {
	return nil, ErrUserCollectionMethodImpl
}
