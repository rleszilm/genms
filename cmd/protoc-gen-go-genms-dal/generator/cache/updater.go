...
func New{{ .C.Message.Name }}Updater(name string, r {{ .P.KeyValue }}.{{ .C.Message.Name }}ReadAller, w {{ .P.KeyValue }}.{{ .C.Message.Name }}Writer, k {{ .P.KeyValue }}.{{ .C.Message.Name }}KeyFunc, i {{ .P.Time }}.Duration) *{{ .C.Message.Name }}Updater {
