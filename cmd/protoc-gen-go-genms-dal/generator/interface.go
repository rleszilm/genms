...
type {{ .I.Message.Name }}CollectionWriter interface {
	...
	Update({{ .P.Context }}.Context, *{{ .I.Message.Name }}FieldValues) (*{{ .I.Message.QualifiedKind }}, error)
}
...
func (x *Unimplemented{{ .I.Message.Name }}Collection) Update(_ {{ .P.Context }}.Context, _ *{{ .I.Message.Name }}FieldValues) (*{{ .I.Message.QualifiedKind }}, error) {
	return nil, Err{{ .I.Message.Name }}CollectionMethodImpl
}
