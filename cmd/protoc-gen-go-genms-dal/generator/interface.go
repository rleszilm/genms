...
type {{ .I.Message.Name }}CollectionWriter interface {
	...
	Update({{ .P.Context }}.Context, *{{ .I.Message.QualifiedKind }}, *{{ .I.Message.Name }}Options) (*{{ .I.Message.QualifiedKind }}, error)
}
...
type {{ .I.Message.Name }}CollectionReader interface {
	...
	Filter({{ .P.Context }}.Context, *{{ .I.Message.Name }}Options) ([]*{{ .I.Message.QualifiedKind }}, error)
...
func (i *Interface) defineOptions() error {
	tmplSrc := `{{- $i := .I -}}
// {{ $i.Message.Name }}Options is an autogenerated struct that can be used in the generic queries against {{ $i.Message.Name }}Collection.
type {{ $i.Message.Name }}Options struct {
...
`
	...
	tmpl, err := template.New("defineInterfaceOptions").
		Funcs(template.FuncMap{
...
func (x *Unimplemented{{ .I.Message.Name }}Collection) Update(_ {{ .P.Context }}.Context, _ *{{ .I.Message.QualifiedKind }}, _ *{{ .I.Message.Name }}Options) (*{{ .I.Message.QualifiedKind }}, error) {
	return nil, Err{{ .I.Message.Name }}CollectionMethodImpl
}

// Filter implements {{ .I.Message.Name }}Collection.Filter
func (x *Unimplemented{{ .I.Message.Name }}Collection) Filter(_ {{ .P.Context }}.Context, _ *{{ .I.Message.Name }}Options) ([]*{{ .I.Message.QualifiedKind }}, error) {
	return nil, Err{{ .I.Message.Name }}CollectionMethodImpl
}
