...
func (fake *FakeProducer) WithDependency(arg1 service.Service) {
...
func (fake *FakeProducer) WithDependencyCallCount() int {
	fake.withDependencyMutex.RLock()
	defer fake.withDependencyMutex.RUnlock()
	return len(fake.withDependencyArgsForCall)
}

func (fake *FakeProducer) WithDependencyCalls(stub func(service.Service)) {
	fake.withDependencyMutex.Lock()
	defer fake.withDependencyMutex.Unlock()
	fake.WithDependencyStub = stub
}

func (fake *FakeProducer) WithDependencyArgsForCall(i int) service.Service {
	fake.withDependencyMutex.RLock()
	defer fake.withDependencyMutex.RUnlock()
